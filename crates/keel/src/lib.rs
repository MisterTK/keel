...
//! Rust project adds this crate itself and calls [`init`]; `keel
//! doctor`/`keel init` do not yet know Rust projects exist. This is real,
...
//! ```
//!
//! (equivalently, `cargo add keelrun --rename keel`). This mirrors how this
